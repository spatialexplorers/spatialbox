...
import { useFocusWithin, useInteractOutside } from ".";
...
export function useOverlay(props: OverlayProps, ref: RefObject<HTMLElement>): OverlayAria {
  ...
  useInteractOutside({ ref, onInteractOutside: isDismissable ? onInteractOutside : undefined, onInteractOutsideStart });
  ...
  let onPointerDownUnderlay = (e: any) => {
